...
from api.routes import auth, users, membership_plans, membership, slider, trainers , static_manager, admin_profile, classes, contact
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://gymster-fronted.onrender.com"],  # Allow frontend domain
